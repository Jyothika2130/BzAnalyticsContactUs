...
export default function PageHero({ title, breadcrumb }: PageHeroProps) {
  return (
    <section className="relative flex h-[300px] w-full items-center overflow-hidden sm:h-[350px] md:h-[550px] lg:h-[80vh]">
      ...
      <div className="relative z-10 mx-auto flex h-full w-full max-w-7xl flex-col px-6 md:px-12">
        ...
        <motion.div
          ...
          className="flex max-w-2xl flex-grow flex-col justify-center "
        >
          ...
          <h1 className="text-2xl font-bold leading-none tracking-tight text-black sm:text-6xl md:text-7xl lg:text-[90px] dark:text-white">
            {title}
          </h1>
